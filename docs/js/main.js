...
var Car = (function () {
    ...
    Car.prototype.removeAstroid = function () {
        this.div.remove();
        this.game.currentscreen.removeFromArray(this);
    };
    return Car;
...
var Level = (function () {
    ...
    Level.prototype.removeFromArray = function (removedMe) {
        var i = this.cars.indexOf(removedMe);
...
var Phaserbeam = (function (_super) {
    ...
    function Phaserbeam(g) {
        ...
        _this.y = _this.game.currentscreen.spaceship.y - 40;
        return _this;
    }
...
var Spaceship = (function (_super) {
    ...
    function Spaceship(left, right, space, g) {
        var _this = _super.call(this) || this;
        _this.downSpeed = 0;
        _this.upSpeed = 0;
        _this.leftSpeed = 0;
        ...
        _this.y = (window.innerHeight / 1.5);
        window.addEventListener("keydown", function (e) { return _this.onKeyDown(e); });
        window.addEventListener("keyup", function (e) { return _this.onKeyUp(e); });
        return _this;
    }
